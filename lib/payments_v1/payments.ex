defmodule PayPal.PaymentsV1.Payments do
  @moduledoc """
  Documentation for PayPal.PaymentsV1.Payments
  """
  ...
  ## Examples
    ...
    iex> PayPal.PaymentsV1.Payments.create(%{
      intent: "sale",
      payer: %{
  ...
  ## Examples
    ...
    iex> PayPal.PaymentsV1.Payments.execute(payment_id, payer_id)
    {:ok, payment}
  """
  ...
  ## Examples
    ...
    iex> PayPal.PaymentsV1.Payments.show(payment_id)
    {:ok, payment}
  """
  ...
  ## Examples
    ...
    iex> PayPal.PaymentsV1.Payments.update(payment_id, [%{
      op: "replace",
  ...
  ## Examples
    ...
    iex> PayPal.PaymentsV1.Payments.show(%{count: 10})
    {:ok, payment}
  """
